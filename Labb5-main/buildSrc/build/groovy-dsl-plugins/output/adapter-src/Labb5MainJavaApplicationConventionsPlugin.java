...
/**
 * Precompiled labb5.main.java-application-conventions script plugin.
 **/
public class Labb5MainJavaApplicationConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Labb5MainJavaApplicationConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("labb5.main.java-common-conventions");
            target.getPluginManager().apply("application");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Labb5MainJavaApplicationConventions").asSubclass(BasicScript.class);
