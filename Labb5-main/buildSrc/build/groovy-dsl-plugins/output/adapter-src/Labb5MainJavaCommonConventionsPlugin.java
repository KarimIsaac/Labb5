...
/**
 * Precompiled labb5.main.java-common-conventions script plugin.
 **/
public class Labb5MainJavaCommonConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_Labb5MainJavaCommonConventions").asSubclass(BasicScript.class);
            ...
            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_Labb5MainJavaCommonConventions").asSubclass(BasicScript.class);
